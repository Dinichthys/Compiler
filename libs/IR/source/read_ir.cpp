...
static enum LangError ReadIRFromBuffer (const char* const buffer, list_t* const list);

static enum LangError CallFuncIR      (current_position_t* const cur_pos, list_t* const list);
static enum LangError FuncBodyIR      (current_position_t* const cur_pos, list_t* const list);
static enum LangError CondJumpIR      (current_position_t* const cur_pos, list_t* const list);
static enum LangError AssignIR        (current_position_t* const cur_pos, list_t* const list);

static enum LangError AssignVarIR     (current_position_t* const cur_pos, list_t* const list);
static enum LangError AssignTmpIR     (current_position_t* const cur_pos, list_t* const list);
static enum LangError AssignArgIR     (current_position_t* const cur_pos, list_t* const list);

static enum LangError OperationIR     (current_position_t* const cur_pos, list_t* const list);
static enum LangError LabelIR         (current_position_t* const cur_pos, list_t* const list);
static enum LangError ReturnIR        (current_position_t* const cur_pos, list_t* const list);
static enum LangError SysCallIR       (current_position_t* const cur_pos, list_t* const list);
static enum LangError GlobalVarsNumIR (current_position_t* const cur_pos, list_t* const list);

static void SkipNumber (const char* const input_buf, size_t* const offset);

typedef enum LangError (*TranslateIRFunc_t) (current_position_t* const cur_pos, list_t* const list);
...
enum LangError ReadIR (const char* const buffer, list_t* const list)
{

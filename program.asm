...
main:	 ; Function body
	...
	push [bx+1]	 ; Push tmp 1 to argument 0 through the stack
in	 ; System call
	pop [bx+2]	 ; Save return value to tmp
	pop 0x	 ; Pop argument out of stack
	...
	add
	pop bx	 ; Shift tmp counter
call func_2_1:	 ; Calling function
	push 5
	push bx
	sub
	pop bx	 ; Shift back tmp counter
	...
	push ax	 ; Push return value to the stack
	pop [bx+4]	 ; Save return value to tmp var

	push 2
	push rsp
	sub
	pop rsp	 ; Shift RSP to skip arguments
	push [bx+4]	 ; Push tmp to variable through the stack
	pop [cx+0]

	push [cx+0]	 ; Push variable to tmp through the stack
	pop [bx+5]

	push [bx+5]	 ; Push tmp 5 to argument 0 through the stack
out	 ; System call
...
func_1_2:	 ; Function body
	...
	push [bx+0]	 ; Push tmp 0 to argument 0 through the stack
out	 ; System call
...
func_2_1_label0:	 ; Label in function
	push [cx+0]	 ; Push variable to tmp through the stack
	pop [bx+0]
...
je func_2_1_label1:	 ; Jump on label if the condition is true
jmp func_2_1_label2:	 ; Jump on label
func_2_1_label1:	 ; Label in function
	push [cx+0]	 ; Push variable to tmp through the stack
	pop [bx+3]
	...
	pop cx	 ; Get var register value back
ret
jmp func_2_1_label3:	 ; Jump on label
func_2_1_label2:	 ; Label in function
	push [cx+0]	 ; Push variable to tmp through the stack
	pop [bx+4]
...
call func_2_1:	 ; Calling function
	...
	pop cx	 ; Get var register value back
ret
func_2_1_label3:	 ; Label in function
